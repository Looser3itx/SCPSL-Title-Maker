def generate_gradient_word(word, start_color, end_color):
    ...
    if word_len > 0:
        ...
        for i in range(word_len):
            ...
            gradient_word += f"{word[i]}</color><color={color}>"

    gradient_word += "</color></b>"
...
if __name__ == "__main__":
    ...
    print("Gradient HTML:", gradient_html)
